...
public class P1ToBifrostController extends GenerateBaseController{
	...
	public Map<String,Object> p1Generate(){
		...
		generate("04-0008-0001",parkEntrance);
	...
	private void generate(String viewCode,String parkEntrance){
		...
		//Generate from to
		 FromToOptimize i2o = geFromTo(parkEntrance, viewCode, true, "3路", "02-0001-0011", "02-0001-0012", 1);
		 locationService.addFromTo(i2o);
		 
		 FromToOptimize o2i = geFromTo(viewCode, parkEntrance, true, "2路", "02-0001-0002", "02-0001-0003", 1);
