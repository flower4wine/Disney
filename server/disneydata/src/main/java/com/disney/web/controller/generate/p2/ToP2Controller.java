...
public class ToP2Controller extends GenerateBaseController{
	...
	public Map<String,Object> p1(){
		...
		for (String parkEntrance : parkEntrances.split(",")) {
			generateP1("03-0001-000C",parkEntrance);
		}
	...
	public Map<String,Object> p3(){
		...
		for (String parkEntrance : parkEntrances.split(",")) {
			generateP34("03-0003-000C",parkEntrance);
			generateP34("03-0003-000D",parkEntrance);
			generateP34("03-0003-000E",parkEntrance);
			generateP34("03-0003-000F",parkEntrance);
		}
	...
	public Map<String,Object> p4(){
		...
		for (String parkEntrance : parkEntrances.split(",")) {
			generateP34("03-0004-000C",parkEntrance);
			generateP34("03-0004-000D",parkEntrance);
		}
	...
	private void generateP1(String viewCode,String parkEntrance){
		//CHECK
		if(locationService.find(viewCode) == null || locationService.find(parkEntrance) == null ){
			return;
		}
		FromToOptimize o2i = geFromTo(viewCode, parkEntrance, true, "3路", "02-0001-0011", "02-0001-0008", 2);

		locationService.addFromTo(o2i);

		List<Integer> list= new ArrayList<Integer>();

		if(parkEntrance.equals("03-0002-000C")){
			for (int i = 1; i <= 71; i++) {
				list.add(i);
			}
			list.add(77);
	...
	private void generateP34(String viewCode,String parkEntrance){
		//CHECK
		if(locationService.find(viewCode) == null || locationService.find(parkEntrance) == null ){
			return;
		}
