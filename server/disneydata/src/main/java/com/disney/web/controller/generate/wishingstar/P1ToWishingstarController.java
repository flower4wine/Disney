...
public class P1ToWishingstarController extends GenerateBaseController{
	...
	public Map<String,Object> p1Generate(){
		...
		generate("04-0004-0001",parkEntrance);
		generate("04-0004-0002",parkEntrance);
	...
	private void generate(String viewCode,String parkEntrance){
		...
		if(viewCode.equals("04-0004-0001")){
			//Generate from to
			 i2o = geFromTo(parkEntrance, viewCode, true, "2路", "02-0001-0003", "02-0001-0004", 1);
			 locationService.addFromTo(i2o);
			 
			 o2i = geFromTo(viewCode, parkEntrance, true, "1路", "02-0001-0004", "02-0001-0011", 1);
			...
			//Generate from to
			 ...
			 o2i = geFromTo(viewCode, parkEntrance, true, "2路", "02-0001-0007", "02-0001-0004", 3);
			 locationService.addFromTo(o2i);
		}
