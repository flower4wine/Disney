(function() {
    ...
    function(n, r, i) {
        ...
        p;
        for (; f < l; f++) h = e[f],
        typeof h[0] == "string" && (a === h[0] && (c = h[2]), h[0] = u + h[0].replace("./", ""), t > 1 && define.apply(this, h));
        return e = [],
        n.get = n,
        typeof c == "function" ? c.apply(this, arguments) : n;
    }),
...
define.pack("./ajax", ["./util"],
function(e, t, n) {
    var r = e("./util"),
    i = {};
    i.request = function(e, t) {
        var n = new XMLHttpRequest;
        typeof n.timeout != "undefined" && (n.timeout = 6e3),
        n.open("get", e, !0),
        n.send(),
...
function(e, t, n) {
    ...
    function() { (function() {
            ...
            t.decode = function(e) {
                ...
                r = 0,
                e.charAt(o - 1) === t.PADCHAR && (r = 1, e.charAt(o - 2) === t.PADCHAR && (r = 2), o -= 4);
                var u = [];
                for (i = 0; i < o; i += 4) s = n(e, i) << 18 | n(e, i + 1) << 12 | n(e, i + 2) << 6 | n(e, i + 3),
                u.push(String.fromCharCode(s >> 16, s >> 8 & 255, s & 255));
                switch (r) {
                case 1:
                    s = n(e, i) << 18 | n(e, i + 1) << 12 | n(e, i + 2) << 6,
                    u.push(String.fromCharCode(s >> 16, s >> 8 & 255));
                    break;
                case 2:
                    s = n(e, i) << 18 | n(e, i + 1) << 12,
            ...
            t.encode = function(e) {
                ...
                for (s = 0; s < f; s += 3) o = i(e, s) << 16 | i(e, s + 1) << 8 | i(e, s + 2),
                u.push(r.charAt(o >> 18)),
                u.push(r.charAt(o >> 12 & 63)),
                u.push(r.charAt(o >> 6 & 63)),
                u.push(r.charAt(o & 63));
                switch (e.length - f) {
                case 1:
                    o = i(e, s) << 16,
                    u.push(r.charAt(o >> 18) + r.charAt(o >> 12 & 63) + n + n);
                    break;
                case 2:
                    o = i(e, s) << 16 | i(e, s + 1) << 8,
                    u.push(r.charAt(o >> 18) + r.charAt(o >> 12 & 63) + r.charAt(o >> 6 & 63) + n);
                }
                return u.join("");
            },
            e.pay = function(e) {
                var n = encodeURIComponent(t.encode(e));
                location.href = "/parkpay/alipay/pay.html?goto=" + n;
            },
            e.decode = function(e) {
...
define.pack("./bind", ["./tmpl", "./ajax", "./cache", "./util", "./success", "./config", "./report"],
function(e, t, n) {
    var r = e("./tmpl"),
    i = e("./ajax"),
    s = e("./cache"),
    ...
    l.init = function() {
        var e = this,
        t = o.Id("p_one_channelList");
        t.addEventListener("click",
        function(t) {
            t.preventDefault();
            if (!e.buttonClickable) return;
            o.showLoading("正在创建订单"),
            e.buttonClickable = !1;
            var t = t || event,
            n = t.target,
            r = n.getAttribute("p_one_channel");
            r == null && (r = n.parentNode.getAttribute("p_one_channel")),
            r == null && (r = n.parentNode.parentNode.getAttribute("p_one_channel"));
            var u = {};
            u.channel = r,
            u.order_no = s.userData.order_no,
            u.amount = s.userData.amount,
            r == "wx_pub" && (u.open_id = s.userData.open_id);
            if (s.userData.charge_param) {
                var a = s.userData.charge_param;
                for (var l in a) u[l] = a[l];
            }
            i.post(s.userData.charge_url, u,
            function(t) {
                o.hideLoading();
                var n;
                try {
        ...
        o.Id("p_one_mask").addEventListener("touchstart",
        function(e) {});
        var r = "ontouchend" in document ? "touchend": "click";
        o.Id("p_one_mask").addEventListener(r,
        function(t) {
            if (!e.maskClickable) return;
            e.buttonClickable = !0,
            e.moveFlag || (o.pop.close(), e.moveFlag = !0, e.maskClickable = !1);
        });
    },
    l.requestCallback = function(e, t) {
        ...
        if (e.status) {
            ...
            u = r.order_no,
            l = r.amount;
            o.cookie._set("PING_APPID_ORDER", s + a.seperator + u + a.seperator + l),
            r["livemode"] == 0 ? n.testModeNotify(r) : (f.report({
                type: "charge_success",
                channel: t,
                ch_id: r.id
            }), n.chargeCallback(t, i));
        } else n.buttonClickable = !0,
        f.report({
            type: "charge_fail",
            channel: t
        }),
    ...
    l.testModeNotify = function(e) {
        var t = this;
        if (e["channel"] == "wx_pub") confirm("模拟付款") && (o.pop.close(), o.hideLoading(), i.request(a.channelURLMap.pingpp_notify_url + e.id + "?livemode=false",
        function(e) {
            ...
            e.order_no && (n.order_no = e.order_no),
            e.extra && (n.extra = encodeURIComponent(JSON.stringify(e.extra))),
            window.location.href = a.channelURLMap.pingpp_mock_url + "?" + o.stringify_data(n);
        }
    },
    l.chargeCallback = function(e, t) {
        ...
        } else if (e == "upacp_wap") o.form_submit(r, "post", t);
        else if (e == "upmp_wap") n.buttonClickable = !0,
        location.href = r + t.paydata;
        else if (e == "bfb_wap") {
            ...
            n.callWXPay(t);
        } else if (e == "jdpay_wap") o.form_submit(r, "post", t);
        else if (e == "yeepay_wap") {
    ...
    l.callWXPay = function(e) {
        ...
        o.pop.close(),
        o.hideLoading(),
        typeof WeixinJSBridge == "undefined" ? document.addEventListener("WeixinJSBridgeReady", n, !1) : n();
    },
    n.exports = l;
}),
define.pack("./cache", [],
...
define.pack("./init", ["./config", "./tmpl", "./cache", "./util", "./ajax", "./bind", "./report", "./ap"],
function(e, t, n) {
    var r = e("./config"),
    i = e("./tmpl"),
    s = e("./cache"),
    ...
    l.init = function(t, n) {
        ...
        h.wx_pub && !o.isInWeixin() && (u = o.removeFromArray(u, "wx_pub")),
        h.upmp_wap && o.isInWeixin() && (u = o.removeFromArray(u, "upmp_wap"));
        ...
        var p = function() {
            if (o.Id("p_one_frame") == null) {
                ...
                a.buttonClickable = !0;
            } else document.getElementById("p_one_frame").style.display = "block",
            a.buttonClickable = !1;
        };
        s.version = 2;
        var d = i.one_style_2(),
...
function(e, t, n) {
    ...
    c = function(e, t, n, r) {
        var i = new XMLHttpRequest;
        typeof i.timeout != "undefined" && (i.timeout = 6e3),
        i.open("post", e, !0),
        i.setRequestHeader("Content-Type", "application/json"),
        i.setRequestHeader("X-Pingpp-Report-Token", n),
        i.send(JSON.stringify(t)),
        i.onreadystatechange = function() {
    ...
    s.report = function(e) {
        ...
        var t = this,
        n = {};
        n.app_id = e.app_id || r.userData.app_id,
        n.ch_id = e.ch_id || "",
        n.channel = e.channel || "",
        n.type = e.type || "",
        n.user_agent = a(),
        ...
        if (localStorage.PPP_ONE_STATS == undefined || localStorage.PPP_ONE_STATS.length == 0) try {
            ...
            localStorage.PPP_ONE_STATS = localStorage.PPP_ONE_STATS + t.seperator + s;
            var l = [],
            h = localStorage.PPP_ONE_STATS.split(t.seperator),
            p = i.MD5(h.join("&"));
...
define.pack("./success", ["./tmpl", "./cache", "./config", "./util"],
function(e, t, n) {
    var r = e("./tmpl"),
    i = e("./cache"),
    s = e("./config"),
    ...
    u.init = function(e, t) {
        ...
        var n = "";
        if (o.cookie._get("PING_APPID_ORDER") == "" || o.cookie._get("PING_APPID_ORDER") == null) n = r.success({});
        else {
            var a = o.cookie._get("PING_APPID_ORDER").split(encodeURIComponent(s.seperator)),
            f = a[0],
            l = a[1],
            c = a[2];
            n = r.success({
    ...
    u.bind = function(e) {
        o.Id("p_one_goon").addEventListener("click",
        function() {
            e();
        });
    },
...
define.pack("./util", ["./cache", "./tmpl", "./config"],
function(e, t, n) {
    var r = e("./cache"),
    i = e("./tmpl"),
    s = e("./config"),
    ...
    o.formatNumber = function(e) {
        ...
        r = "",
        i = "";
        return n == 1 ? (r = "0", i = "0" + t) : n == 2 ? (r = "0", i = t) : (r = t.substring(0, n - 2), i = t.substr(n - 2)),
        r + "." + i;
    },
    ...
    o.pop = {
        open: function() {
            o.addClass(document.body, "p_one_open"),
            o.addClass(document.getElementsByClassName("p_one_html")[0], "in");
        },
        close: function() {
            o.removeClass(document.getElementsByClassName("p_one_html")[0], "in"),
            setTimeout(function() {
                document.getElementById("p_one_frame").style.display = "none";
            },
            400),
            o.removeClass(document.body, "p_one_open");
        }
    },
    ...
    o.getToken = function(e) {},
    o.isInWeixin = function() {
...
function(e, t, n) {
    var r = {
        ...
        one_2: function(e) {
            ...
            t.push("    "),
            n(e.style),
            t.push('    <div id="p_one_mask" class="p_one_mask"></div>\r\n    <div class="p_one_window'),
            n(navigator.userAgent.toLowerCase().match("iphone") ? "": " p_one_default"),
            t.push('">\r\n        <div class="p_one_html">\r\n            <div class="p_one_body">\r\n                <div id="p_one_channelList" class="p_one_channel">');
            for (var r = 0; r < e.channelArr.length; r++) t.push("                    "),
            e.channelArr[r] == "alipay_wap" && t.push('                    <div p_one_channel="alipay_wap" class="p_one_btn"><div class="p_one_icon_alipay">支付宝</div></div>'),
            t.push("                    "),
            e.channelArr[r] == "wx_pub" && t.push('                    <div p_one_channel="wx_pub" class="p_one_btn"><div class="p_one_icon_wechat">微信支付</div></div>'),
            t.push("                    "),
            e.channelArr[r] == "upacp_wap" && t.push('                    <div p_one_channel="upacp_wap" class="p_one_btn"><div class="p_one_icon_unionpay">银联支付</div></div>'),
            t.push("                    "),
            e.channelArr[r] == "upmp_wap" && t.push('                    <div p_one_channel="upmp_wap" class="p_one_btn"><div class="p_one_icon_unionpay">银联支付</div></div>'),
            t.push("                    "),
            e.channelArr[r] == "bfb_wap" && t.push('                    <div p_one_channel="bfb_wap" class="p_one_btn"><div class="p_one_icon_baidu">百度钱包</div></div>'),
            t.push("                    "),
            e.channelArr[r] == "jdpay_wap" && t.push('                    <div p_one_channel="jdpay_wap" class="p_one_btn"><div class="p_one_icon_jdpay">京东支付</div></div>'),
            t.push("                    "),
            e.channelArr[r] == "yeepay_wap" && t.push('                    <div p_one_channel="yeepay_wap" class="p_one_btn"><div class="p_one_icon_yeepay">易宝支付</div></div>'),
            t.push("                    ");
            return t.push("                </div>\r\n            </div>\r\n        </div>\r\n    </div>"),
            t.join("");
        },
