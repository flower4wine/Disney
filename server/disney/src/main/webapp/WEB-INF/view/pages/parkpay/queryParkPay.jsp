...
<body>
	<div class="disney-bg-full">
		...
		<div style="text-align: center;background-color: rgba(7,7,7,0.7);height:100%;">
			...
			<div>
				<input style="height: 60px;width:80%;padding: 15px;font-size: 180%;text-align: center;border-radius:4px;border: none;letter-spacing: 2px;">
			</div>
			<div style="padding: 20px 0;" onclick="window.location='/disney/parkpay/parkpay.html';">
